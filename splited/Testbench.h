...
public:
	...
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result_r;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result_g;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result_b;
#else
	sc_fifo_out< sc_dt::sc_uint<8> > o_r;
	sc_fifo_out< sc_dt::sc_uint<8> > o_g;
	sc_fifo_out< sc_dt::sc_uint<8> > o_b;
	sc_fifo_in< sc_dt::sc_uint<8> > i_result_r;
	sc_fifo_in< sc_dt::sc_uint<8> > i_result_g;
	sc_fifo_in< sc_dt::sc_uint<8> > i_result_b;
#endif
